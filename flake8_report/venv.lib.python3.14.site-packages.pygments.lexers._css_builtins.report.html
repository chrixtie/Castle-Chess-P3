...
<html>
   <head>
      <title>flake8 violations: .venv/lib/python3.14/site-packages/pygments/lexers/_css_builtins.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.lib.python3.14.site-packages.pygments.lexers._css_builtins.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               .venv/lib/python3.14/site-packages/pygments/lexers/_css_builtins.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.lib.python3.14.site-packages.pygments.lexers._css_builtins.source.html#l558">
